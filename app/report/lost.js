  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.label}>Data em que viu pela última vez</Text>
        <TextInput
        ...
        <Text style={styles.label}>Local em que viu pela última vez</Text>
        <TextInput
      ...
      <View style={styles.card}>
        ...
        <TextInput
          placeholder="Qualquer detalhe diferente que possa destinguir de outros itens"
          placeholderTextColor="#888"
          style={styles.textarea}
          multiline
          value={extraInfo}
